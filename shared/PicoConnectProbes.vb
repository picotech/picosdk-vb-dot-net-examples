...
Module PicoConnectProbes
    ...
    Enum PicoConnectProbe
        ...
        PICO_CONNECT_PROBE_INTELLIGENT = &HFFFFFFFD

        PICO_CONNECT_PROBE_UNKNOWN_PROBE = &HFFFFFFFE
        PICO_CONNECT_PROBE_FAULT_PROBE = &HFFFFFFFF

    End Enum

    Enum PicoConnectProbeRange
        ...
        PICO_PS4000A_RESISTANCE_315K = &H200
        ...
        PICO_PS4000A_RESISTANCE_ADCV_FLAG = &H10000000
    ...
    '
    ' ================================================================
    Public Function getPicoConnectProbeString(ByVal name As PicoConnectProbe) As String
